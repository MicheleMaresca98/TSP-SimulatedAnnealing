...
#    b = 554070.556050  # 19947008.20167722 #239297 #2579 #3323  # best solution istanza benchmark
    L = 60
    t_in = [10**i for i in range(1,10)]
    t_fin = 1
    alpha = 0.99

    with open("Test/nearest_neighbour_burma/test_ordini_di_grandezza_burma14_v2.txt", 'w') as f:
        f.write('test for nearest_neighbour_burma14_v2.txt : \n')
        print("secondo: \n")
        for i in range(0, 9):
